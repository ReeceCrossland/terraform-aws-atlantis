...
| <a name="input_efs_tags"></a> [efs\_tags](#input\_efs\_tags) | Additional tags to put on EFS resources | `map(string)` | `{}` | no |
...
| <a name="input_execution_role_arn"></a> [execution\_role\_arn](#input\_execution\_role\_arn) | Optional execution IAM role ARN for the ECS Atlantis task | `string` | `""` | no |
...
| <a name="input_log_group_name"></a> [log\_group\_name](#input\_log\_group\_name) | Custom name for log group | `string` | `""` | no |
